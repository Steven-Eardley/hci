...
experience once a user has reached a stage of familiarity with the task. These
will be learnt during the investigative phase via tooltips that appear over the
buttons.
