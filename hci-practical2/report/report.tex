...
As we are evaluating software 1 specifically a more detailed analysis of the areas for improvements is required, our results show that the documentation, toggling of modes, provide feedback from interactions, moving the shape as a whole not point by point, filtering of files and a general improvement in aesthetic are the todo points for the software.
